...
_CATEGORY_MINOR_TO_MAJOR = {
    STANCE_MINOR_CATEGORY.STRONG_SUPPORT: STANCE_MAJOR_CATEGORY.PRO_UBI,
    STANCE_MINOR_CATEGORY.CONDITIONAL_SUPPORT: STANCE_MAJOR_CATEGORY.PRO_UBI,
    STANCE_MINOR_CATEGORY.RATIONAL_SUPPORT: STANCE_MAJOR_CATEGORY.PRO_UBI,
    STANCE_MINOR_CATEGORY.STRONG_OPPONENT: STANCE_MAJOR_CATEGORY.ANTI_UBI,
    STANCE_MINOR_CATEGORY.CONDITIONAL_OPPONENT: STANCE_MAJOR_CATEGORY.ANTI_UBI,
    STANCE_MINOR_CATEGORY.RATIONAL_OPPONENT: STANCE_MAJOR_CATEGORY.ANTI_UBI,
    STANCE_MINOR_CATEGORY.OBSERVATIONAL: STANCE_MAJOR_CATEGORY.NEUTRAL,
    STANCE_MINOR_CATEGORY.QUESTIONING: STANCE_MAJOR_CATEGORY.NEUTRAL,
    STANCE_MINOR_CATEGORY.ALTERNATIVE_PROPOSAL: STANCE_MAJOR_CATEGORY.NEUTRAL,
}
...
class StanceClassifier(object):
    ...
    def _classify(self, comment_text: str) -> StanceClassificationResult:
        ...
        result = StanceClassificationResult(
            major_category=_CATEGORY_MINOR_TO_MAJOR[minor_category].value,
